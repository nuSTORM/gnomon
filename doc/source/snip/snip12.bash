...
echo export LOG4CPP=\${GENIE}/v1_0/stage >> $VIRTUAL_ENV/bin/activate
...
echo eval \${LLP}=\${!LLP}:\${LHAPDF}/lib:\${GENIE}/lib:\${PYTHIA6}/lib:/opt/local/lib:\$LOG4CPP/lib >> $VIRTUAL_ENV/bin/activate

source $VIRTUAL_ENV/bin/activate

./src/scripts/build/ext/build_lhapdf.sh 5.8.8 --refetch

./src/scripts/build/ext/build_log4cpp.sh 
